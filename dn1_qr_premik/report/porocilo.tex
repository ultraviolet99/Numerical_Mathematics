...
\newcommand{\dopolni}[1]{\textcolor{red}{\textbf{[DOPOLNI: #1]}}}
...
Redukcija na tridiagonalno obliko je najdražji del in stane $\mathcal{O}(n^3)$
...
med drugo in tretjo lastno vrednostjo pa je velika vrzel (slika~\ref{fig:gruce}).
