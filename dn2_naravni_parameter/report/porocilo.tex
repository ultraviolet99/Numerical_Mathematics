...
$[0, T_0] \to [-1, 1]$ da za najbližje razvejišče $\rho \approx 1{,}34$, torej
...
\begin{figure}[htb]\centering
  ...
  $\log_{10}19 \approx 1,3$ decimalke na koeficient, $\approx 12$ koeficientov do strojne natančnosti. 
  Izbrani $n = 60$ in
  $M = 40$ sta zato precej nad potrebnim minimumom, kar pusti udobno rezervo
...
Klic je enake oblike ne glede na velikost argumenta. Katero vejo
funkcija uporabi in kako draga je bila priprava zanjo, ostane skrito:
...
\bibitem{atap} L.~N. Trefethen, \emph{Approximation Theory and Approximation
  Practice}, SIAM, 2013, pogl.~8 in~19.
